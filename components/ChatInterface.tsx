          ...
          <div className="flex items-center gap-3 pb-1">
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
                Dan Buglio's Public KnowledgeBot
              </h1>
              {isInitialized && (
          ...
          {!isInitialized ? (
            ...
            <div className="text-center py-16">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-3">
                Welcome to Dan Buglio's Public KnowledgeBot
              </h2>
              <p className="text-gray-600 mb-8 max-w-lg mx-auto leading-relaxed">
                This assistant is based on Dan Buglio's public content.
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto mb-8">
                ...
                <div className="text-center p-4">
                  <div className="w-12 h-12 bg-green-100 rounded-2xl flex items-center justify-center mx-auto mb-3">
                    <HeartCrack className="w-6 h-6 text-green-600" />
                  </div>
                  <h3 className="font-semibold text-gray-800 mb-1">
                    Emotional Insight
                  </h3>
                  <p className="text-sm text-gray-600">
                    Discover how your emotions may be connected to chronic pain
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-xl mx-auto">
                  ...
                  <div className="text-center p-3">
                    <div className="w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center mx-auto mb-2">
                      <HeartCrack className="w-5 h-5 text-green-600" />
                    </div>
                    <h4 className="font-semibold text-gray-800 mb-1 text-sm">
                      Emotional Insight
                    </h4>
